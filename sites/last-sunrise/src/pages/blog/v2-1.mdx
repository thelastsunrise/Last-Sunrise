...
<BlogImage imgSrc="../../images/blog/2x1-sketches.png" imgAlt="Two sketches of the site layouts. The leftmost one follows the same color scheme as the index, with a lot of the same style motifs. The rightmost one is an almost exact match of the final blog page. Both pictures have a really similar layout.">
...
<BlogImage imgSrc="../../images/blog/2x1-palettes.png" imgAlt="An array of different color themes for the layout sketch from above. There's nine shown in the screenshot.">
