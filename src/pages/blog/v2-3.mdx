...
<ImageCardFloat placement="start" imgSrc="../../images/blog/2x3-sketches.png" imgAlt="A very rough and unfinished color map for the MGS shrine.">
...
<ImageCardFloat placement="end" imgSrc="../../images/blog/2x3-codec.jpg" imgAlt="A screenshot of the MGS1 codec UI.">
