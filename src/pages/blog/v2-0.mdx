...
<ImageCardFloat placement="start" imgSrc="../images/blog/2x0-index1.PNG" imgAlt="A screenshot of the second attempt at the v2.0 index. Notably there's a button to toggle a dark mode, and a highlight for mobile accessibility in the site updates.">
...
<ImageCardFloat placement="end" imgSrc="../images/blog/2x0-inspo.PNG" imgAlt="A retro looking poster for a James Taylor concert in the Newark, NJ Prudential Center. Of note are the colors and cloud motif, which were very similar to the Last Sunrise v2 index.">
...
<ImageCardFloat placement="start" imgSrc="../images/blog/2x0-sketches.PNG" imgAlt="Two very rough of the website layout. The leftmost one has some color, similar to the final product, and the rightmost one is just black and white, but more true to the final layout.">
